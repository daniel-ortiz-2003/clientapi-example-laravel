                            ...
                            <div class="row form-group">
                                <div class="col-lg-6">
                                    ...
                                    <table id="table_data_available" class="table table-striped table-hover">
                                        ...
                                        <tbody>
                                            @if(empty($order['availableActivities']) || count($order['availableActivities']) == 0)
                                                <tr>
                                                    <td colspan="4">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <table id="table_data_added" class="table table-striped table-hover">
                                        ...
                                        <tbody>
                                            @if(empty($order['order']['activities']) || count($order['order']['activities']) == 0)
                                                <tr>
                                                    <td colspan="4">
                                            ...
                                            @else
                                                @foreach ($order['order']['activities'] as $activity)
                                                    <tr>
                                                        ...
                                                        <td>{{ $activity['hours'] }}</td>
                                                        <td>
                                                            <a href="{{ route('order.remove_activity', [$order['order']['id'], $activity['id']]) }}" class="btn btn-danger btn-circle btn-sm" title="Retirar">
