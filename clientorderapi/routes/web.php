...
Route::prefix('reports')->group(function(){
    ...
    Route::post('/export_activities_by_technician', [ReportController::class, 'export_activities_by_technician'])->name('reports.activities_by_technician');
    Route::post('/export_order_rank_date', [ReportController::class, 'export_order_rank_date'])->name('reports.order_rank_date');
});
